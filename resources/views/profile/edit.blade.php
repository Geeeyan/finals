...
.page-title { font-family: 'Space Grotesk', sans-serif; font-size: 1.85rem; font-weight: 700; letter-spacing: -.02em; margin-bottom: 4px; }
...
.avatar-preview:hover { border-color: #ff3b30; }
...
.upload-meta { flex: 1; min-width: 200px; }
.upload-meta p { font-size: .82rem; color: rgba(255,255,255,.35); margin-top: 6px; line-height: 1.5; }
...
.role-badge {
  ...
  background: rgba(255,59,48,.14); border: 1px solid rgba(255,59,48,.3); color: #ff3b30;
}

.stat-row { display: flex; gap: 12px; flex-wrap: wrap; margin-top: 20px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,.07); }
.stat-pill { flex: 1; min-width: 120px; background: rgba(255,255,255,.04); border: 1px solid rgba(255,255,255,.07); border-radius: 12px; padding: 14px 18px; }
...
.btn-primary-custom {
  padding: 11px 24px; background: #ff3b30; border: none; border-radius: 12px;
...
.btn-ghost {
  ...
  border-radius: 12px; color: rgba(255,255,255,.5); font-family: 'DM Sans', sans-serif;
...
.back-link { display: inline-flex; align-items: center; gap: 8px; color: rgba(255,255,255,.4); font-size: .85rem; text-decoration: none; margin-bottom: 32px; transition: color .2s; }
